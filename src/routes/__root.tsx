  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "See what a practice keeps each month and year when appliances come in-house — including the full internal cost.",
      },
      { name: "theme-color", content: "#1e4a43" },
    ],
    links: [
